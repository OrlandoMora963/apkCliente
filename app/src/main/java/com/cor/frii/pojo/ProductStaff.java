...
public class ProductStaff {
    ...
    public void setCompanyID(com.cor.frii.pojo.company_id value) { this.company_id = value; }

    public product_id getProductID() { return product_id; }
    public void setProductID(com.cor.frii.pojo.product_id value) { this.product_id = value; }
}
